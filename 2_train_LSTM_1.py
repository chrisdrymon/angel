    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if logs['val_accuracy'] > self.best_val_acc:
            ...
            model_name = os.path.join('models',
                                      f'pos-2x128-{logs["accuracy"]:.3f}val{logs["val_accuracy"]:.3f}-fullAGDT')
...
model.add(layers.Bidirectional(layers.LSTM(128, activation='relu', return_sequences=True), input_shape=(21, 219)))
